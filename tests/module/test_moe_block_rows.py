...
from xtuner.v1.module.dispatcher import ExpertWeights, Layout, PostDispatchResult, rows_from_counts, rows_from_psum
...
def _batch(valid: list[int], alignment: int, fp8_input: bool, tail: int = 0):
    ...
    assert rows.layout is (Layout.EA if alignment > 1 else Layout.E0)
